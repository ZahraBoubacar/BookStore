...
Lancer en local : voir section Installation ci-dessous.
...
Catalogue par catégorie + auteurs



CRUD livres (ajout / modification / suppression)





Fiche livre (détails, prix TND, note)
...
Bibliothèque personnelle (statut, notes, défis)
...
Librairie complète — catalogue, auteurs, fiches livres, panier et commande



Bibliothèque personnelle — statut de lecture, notes, défis de lecture



KitabAI — assistant de recommandation par règles locales (sans API externe payante)



Quiz littéraire — interaction ludique autour des livres



Auth & commandes — inscription, connexion, tableau de bord, historique
...
UX française — routes en français (/compte, /bibliotheque, /panier, /livres, …)
